          ...
          <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
            ...
            <h1 className="lg:flex text-[28px] lg:text-4xl text-dolphin font-bold text-transparent tracking-[-3px]">
              Mortgage
                ...
                <p className="text-xl mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                  With a Better Rate from us, you could have more money for what
                  matters most.
                </p>
                ...
                <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                  <li>
                    <a
                      ...
                      rel="noreferrer"
                      target="_blank"
                      className="text-applyBtnOrange transition hover:text-applyBtnOrange/75"
                    >
              ...
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                <div className="text-center sm:text-left">
                  <p className="font-medium text-gray-900 text-lg">About Us</p>
